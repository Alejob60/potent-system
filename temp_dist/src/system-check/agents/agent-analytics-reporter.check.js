...
async function testAgentAnalyticsReporter() {
    const baseUrl = process.env.AGENT_ANALYTICS_REPORTER_URL ||
        'http://localhost:3000/agents/analytics-reporter';
    try {
        const createRes = await axios_1.default.post(baseUrl, {
            metric: 'engagement',
            period: 'daily',
        });
...
//# sourceMappingURL=agent-analytics-reporter.check.js.map