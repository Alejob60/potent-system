...
exports.AgentVideoScriptorV2Service = void 0;
...
let AgentVideoScriptorV2Service = class AgentVideoScriptorV2Service extends agent_base_1.AgentBase {
    constructor(repo, redisService, stateManager, websocketGateway) {
        super('video-scriptor-v2', 'Generate emotional video scripts adapted for specific platforms with enhanced capabilities', ['script_generation', 'emotional_narrative', 'platform_adaptation', 'visual_suggestions'], redisService, stateManager, websocketGateway);
        this.repo = repo;
    }
    async execute(payload) {
        ...
        try {
            ...
            this.logActivity(payload.sessionId, 'Starting script generation', payload);
            ...
            this.logActivity(payload.sessionId, 'Script generation completed', { processingTime, format: payload.format, platform: payload.platform });
    ...
    async generateScriptWithNarrative(dto) {
    ...
    generateNarrative(emotion, platform) {
        const narratives = {
            excited: {
                ...
                youtube: ' Amigos, esto es un GAME CHANGER! Estoy literalmente temblando de emoci n mientras les muestro esta incre ble herramienta que va a transformar su contenido.',
            },
            curious: {
                ...
                youtube: 'Hoy vamos a explorar juntos un territorio desconocido. No tengo todas las respuestas, pero el viaje de descubrimiento ser  incre ble.  Vienen conmigo?',
            },
            focused: {
                ...
                youtube: 'Hoy vamos a desglosar esto cient ficamente. Cada punto est  respaldado por datos y experiencia. Prep rense para una sesi n de aprendizaje intensiva.',
            },
        };
...
exports.AgentVideoScriptorV2Service = AgentVideoScriptorV2Service;
exports.AgentVideoScriptorV2Service = AgentVideoScriptorV2Service = __decorate([
...
//# sourceMappingURL=agent-video-scriptor-v2.service.js.map