...
const context_management_controller_1 = require("./context-management.controller");
...
exports.ContextManagementModule = ContextManagementModule = __decorate([
    (0, common_1.Module)({
        controllers: [context_management_controller_1.ContextManagementController],
        providers: [context_management_service_1.ContextManagementService],
        exports: [context_management_service_1.ContextManagementService],
    })
