...
import { ScrumTimelineV2Service } from './scrum-timeline-v2.service';
import { RedisService } from '../../../common/redis/redis.service';
import { StateManagementService } from '../../../state/state-management.service';
import { WebSocketGatewayService } from '../../../websocket/websocket.gateway';

describe('ScrumTimelineV2Service', () => {
  let service: ScrumTimelineV2Service;
  ...
  beforeEach(async () => {
    ...
    service = module.get<ScrumTimelineV2Service>(ScrumTimelineV2Service);
  });
  ...
  describe('execute', () => {
    it('should successfully synchronize scrum timeline', async () => {
      const payload = {
