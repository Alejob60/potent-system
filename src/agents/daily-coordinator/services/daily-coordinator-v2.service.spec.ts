...
import { DailyCoordinatorV2Service } from './daily-coordinator-v2.service';
import { RedisService } from '../../../common/redis/redis.service';
import { StateManagementService } from '../../../state/state-management.service';
import { WebSocketGatewayService } from '../../../websocket/websocket.gateway';

describe('DailyCoordinatorV2Service', () => {
  let service: DailyCoordinatorV2Service;
  ...
  beforeEach(async () => {
    ...
    service = module.get<DailyCoordinatorV2Service>(DailyCoordinatorV2Service);
  });
  ...
  describe('execute', () => {
    it('should successfully coordinate daily activities', async () => {
      const payload = {
      ...
      expect(result.data.agentsBriefed).toBeDefined();
    });
