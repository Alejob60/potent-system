...
import { FrontDeskV2Service } from './front-desk-v2.service';
import { RedisService } from '../../../common/redis/redis.service';
import { StateManagementService } from '../../../state/state-management.service';
import { WebSocketGatewayService } from '../../../websocket/websocket.gateway';

describe('FrontDeskV2Service', () => {
  let service: FrontDeskV2Service;
  ...
  beforeEach(async () => {
    ...
    service = module.get<FrontDeskV2Service>(FrontDeskV2Service);
  });
  ...
  describe('execute', () => {
    it('should successfully process a message', async () => {
      const payload = {
        ...
        message: 'I need help with trend analysis',
      };
