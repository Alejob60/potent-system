...
@Injectable()
export class PurchaseIntentDetectorService {
  private readonly logger = new Logger(PurchaseIntentDetectorService.name);
   ...
   */
  private extractProductReferences(message: string, context?: any): string[] {
   ...
   */
  private calculateUrgencyLevel(message: string): number {
