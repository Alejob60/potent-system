...
async function testAgentVideoScriptor() {
    const baseUrl = process.env.AGENT_VIDEO_SCRIPTOR_URL ||
        'http://localhost:3000/agents/video-scriptor';
    try {
        const createRes = await axios_1.default.post(baseUrl, { topic: 'demo video' });
...
if (require.main === module) {
    testAgentVideoScriptor();
}
//# sourceMappingURL=agent-video-scriptor.check.js.map