...
exports.AgentTrendScannerV1Controller = void 0;
const common_1 = require("@nestjs/common");
const agent_trend_scanner_base_1 = require("../../../../agents/agent-trend-scanner/agent-trend-scanner.base");
const create_agent_trend_scanner_dto_1 = require("../../../../agents/agent-trend-scanner/dto/create-agent-trend-scanner.dto");
const swagger_1 = require("@nestjs/swagger");
let AgentTrendScannerV1Controller = class AgentTrendScannerV1Controller {
    constructor() {
        this.agent = new agent_trend_scanner_base_1.AgentTrendScannerBase();
    }
    async create(dto) {
...
exports.AgentTrendScannerV1Controller = AgentTrendScannerV1Controller;
__decorate([
    (0, common_1.Post)(),
...
], AgentTrendScannerV1Controller.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({
    ...
    __metadata("design:returntype", Promise)
], AgentTrendScannerV1Controller.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({
    ...
    __metadata("design:returntype", Promise)
], AgentTrendScannerV1Controller.prototype, "findOne", null);
exports.AgentTrendScannerV1Controller = AgentTrendScannerV1Controller = __decorate([
    (0, swagger_1.ApiTags)('agents'),
    (0, common_1.Controller)('agents/trend-scanner'),
    __metadata("design:paramtypes", [])
], AgentTrendScannerV1Controller);
//# sourceMappingURL=agent-trend-scanner-v1.controller.js.map