#!/usr/bin/env node
/**
 * Docker Service Startup Script
 * 
 * This script helps start the required services using Docker.
 * It provides instructions for users who prefer to run services via Docker.
 */
...
async function checkDockerCompose() {
  return new Promise<boolean>((resolve) => {
    const dockerCompose = spawn('docker-compose', ['--version']);
