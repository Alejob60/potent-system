...
async function testKeywordRouting() {
  console.log('=== PRUEBA DE ENRUTAMIENTO POR PALABRAS CLAVE ===\n');
  ...
  const testMessages = [
    {
      message: 'Quiero crear un video script para mi producto',
      expected: 'video-scriptor'
    },
    {
      message: 'Necesito ayuda con las social trends',
      expected: 'trend-scanner'
    },
    {
      message: 'Tengo una faq sobre mi cuenta',
      expected: 'faq-responder'
    },
    {
      message: 'Quiero schedule una publicación para mañana',
      expected: 'post-scheduler'
    },
    {
      message: 'Necesito un analytics report de mi campaña',
