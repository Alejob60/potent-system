...
exports.AgentTrendScannerService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const agent_trend_scanner_entity_1 = require("../entities/agent-trend-scanner.entity");
let AgentTrendScannerService = class AgentTrendScannerService {
    constructor(agentTrendScannerRepository) {
...
exports.AgentTrendScannerService = AgentTrendScannerService;
exports.AgentTrendScannerService = AgentTrendScannerService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(agent_trend_scanner_entity_1.AgentTrendScanner)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], AgentTrendScannerService);
//# sourceMappingURL=agent-trend-scanner.service.js.map